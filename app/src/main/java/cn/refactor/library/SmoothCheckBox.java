...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, (int)Util.pxFromDp(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = (int)Util.pxFromDp(getContext(), DEF_DRAW_SIZE);
